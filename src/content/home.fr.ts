  ...
  contact: {
    ...
    form: {
      ...
      fleetOptions: [
        ...
        { value: "1-5", label: "1–5 véhicules" },
        { value: "6-20", label: "6–20 véhicules" },
        { value: "21-50", label: "21–50 véhicules" },
        { value: "51+", label: "51+ véhicules" },
      ],
      consentLabel: "J’accepte d’être contacté·e.",
      privacyLink: "/privacy",
